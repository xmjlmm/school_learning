...
'''
# 4
ans = 12345678901234567890123456789012345678901234567890 % 2023
print(ans)'''
...
'''# 5
import math
s = 9719 7515 5916 6467 7157 9614 8560 9075 2099 2838 1403 7652 6238 1699 8907 1804 5384 7942 7546 1978
...
for i in range(n):
    for j in range(m):
        ...
        ele = ls[i][j]
        ans = 0
        if ele == ls[i - 1][j - 1] and ls[i - 1][j + 1] == ele and ls[i + 1][j] == ele:
            ans = ans + i
        a = i - 1
        b = j - 1
        c = i + 1
        ...
        while True:
            ...
            if d > m:
                break
            if ls[a - 1][b - 1] == ele and ls[a - 1][b + 1] == ele and ls[c + 1] == ele:
                ans = ans + 1
            a = i - 1
            b = j - 1
            c = i + 1
