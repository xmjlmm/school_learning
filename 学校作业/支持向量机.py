...
#         # 创建SVM模型，这里使用径向基函数（RBF）核，你可以根据需要调整参数
...
#     wandb.init(project="mnist_svm", name="SVM_Experiment")
...
#     accuracies, precisions, recalls, f1_scores = svm(trainData, trainLabel, testData, testLabel)
...
if __name__ == '__main__':
    ...
    accuracies, precisions, recalls, f1_scores, fpr_list, tpr_list, auc_list, confusion_matrices = svm(trainData,
                                                                                                      trainLabel,
                                                                                                      testData,
                                                                                                      testLabel)
