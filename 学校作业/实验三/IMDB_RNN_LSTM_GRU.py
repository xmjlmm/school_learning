...
# 统一训练函数 
def train_and_evaluate(model, train_loader, val_loader, test_loader, config):  
...
for name, model in models.items():   
    print(f"\n=== Training {name} Model ===")  
    results[name] = train_and_evaluate(model, train_loader, val_loader, test_loader, config)  
