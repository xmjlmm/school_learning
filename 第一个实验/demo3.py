...
def train_model():
    ...
    # 编译模型 - 移除已弃用的decay参数
    sgd = SGD(learning_rate=0.001, momentum=0.9, nesterov=True)  # 移除decay参数
    model.compile(
    ...
    # 保存最终模型 - 使用新的Keras格式
    final_model_path = "weights/alexnet_cat_dog_final.keras"
...
def main():
    ...
    try:
        ...
        print("\n训练完成！")
        print("生成的文件:")
        print("- weights/best_alexnet_cat_dog.keras (最佳模型)")
        print("- weights/alexnet_cat_dog_final.keras (最终模型)")
